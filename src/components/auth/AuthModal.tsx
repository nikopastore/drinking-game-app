  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} size="sm">
      <div className="flex flex-col items-center text-center px-2 py-4">
        {/* Logo/Icon */}
        <div className="w-16 h-16 rounded-full bg-gradient-to-br from-neon-pink to-neon-purple flex items-center justify-center mb-4">
          <span className="text-3xl">🍻</span>
        </div>

        {/* Title */}
        <h2 className="text-xl font-bold text-white mb-2">
          {gameName ? `Sign up to play ${gameName}` : "Sign up to play"}
        </h2>

        {/* Subtitle */}
        <p className="text-gray-400 text-sm mb-6">
          Create an account to access all games and find friends
        </p>
