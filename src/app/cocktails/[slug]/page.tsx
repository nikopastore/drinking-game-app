...
export default function CocktailPage() {
  ...
  const cocktail = getCocktailBySlug(params.slug as string);

  if (!cocktail) {
    return (
      <div className="min-h-screen bg-dark-900 flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-white mb-4">Cocktail not found</h1>
          <Button onClick={() => router.push("/cocktails")}>
        ...
        <div className="mb-8">
          <div className="flex items-start justify-between mb-4">
            ...
            <div className="flex gap-2">
              ...
              <button className="p-2 rounded-lg bg-dark-700 text-gray-400 hover:text-neon-pink hover:bg-dark-600 transition-colors">
