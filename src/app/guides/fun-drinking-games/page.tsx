...
export default function FunDrinkingGamesPage() {
  return (
    <GuideLayout title="Most Fun Drinking Games" description="Looking for games that are actually FUN and not just about getting drunk? These games bring the entertainment, laughs, and memorable moments." breadcrumb="Fun Games" relatedGames={[{ name: "Most Likely To", slug: "most-likely-to", description: "Always hilarious" }, { name: "Medusa", slug: "medusa", description: "Guaranteed laughs" }]}>
      ...
      <ul><li><Link href="/games/most-likely-to" className="text-neon-pink">Most Likely To</Link> - Hilarious revelations</li><li><Link href="/games/medusa" className="text-neon-pink">Medusa</Link> - Dramatic eye contact</li><li><Link href="/games/cheers-to-the-governor" className="text-neon-pink">Cheers to the Governor</Link> - Escalating chaos</li><li><Link href="/games/bite-the-bag" className="text-neon-pink">Bite the Bag</Link> - Physical comedy gold</li></ul>
