...
export default function DateNightDrinkingGamesPage() {
  return (
    <GuideLayout title="Date Night Drinking Games" description="Stay in and have fun! These games are perfect for couples looking to add some excitement to date night at home." breadcrumb="Date Night" relatedGames={[{ name: "Truth or Drink", slug: "truth-or-drink", description: "Learn something new" }, { name: "Never Have I Ever", slug: "never-have-i-ever", description: "Couples edition" }]}>
      ...
      <ul><li><Link href="/game/truth-or-drink" className="text-neon-pink">Truth or Drink</Link> - Deep questions</li><li><strong>Two Truths One Lie</strong> - Discover secrets</li><li><strong>This or That</strong> - Quick fire preferences</li></ul>
      <h2>Flirty Games</h2>
      <ul><li><Link href="/game/never-have-i-ever" className="text-neon-pink">Never Have I Ever</Link> - Spicy edition</li><li><strong>Strip or Drink</strong> - You choose</li><li><strong>Compliment or Drink</strong> - Say something nice</li></ul>
