...
export default function DrinkingGameIdeasPage() {
  return (
    <GuideLayout title="Drinking Game Ideas" description="Not sure what to play? Browse our comprehensive list of drinking game ideas organized by category, group size, and vibe." breadcrumb="Game Ideas" relatedGames={[{ name: "Kings Cup", slug: "kings-cup", description: "Classic choice" }, { name: "Never Have I Ever", slug: "never-have-i-ever", description: "Always works" }]}>
      <h2>By Group Size</h2>
      <ul><li><strong>2 people:</strong> <Link href="/game/truth-or-drink" className="text-neon-pink">Truth or Drink</Link>, Higher or Lower</li><li><strong>3-5 people:</strong> <Link href="/game/kings-cup" className="text-neon-pink">Kings Cup</Link>, <Link href="/game/ride-the-bus" className="text-neon-pink">Ride the Bus</Link></li><li><strong>6-10 people:</strong> <Link href="/game/flip-cup" className="text-neon-pink">Flip Cup</Link>, <Link href="/game/rage-cage" className="text-neon-pink">Rage Cage</Link></li><li><strong>10+ people:</strong> <Link href="/game/most-likely-to" className="text-neon-pink">Most Likely To</Link>, <Link href="/game/never-have-i-ever" className="text-neon-pink">Never Have I Ever</Link></li></ul>
      <h2>By Vibe</h2>
