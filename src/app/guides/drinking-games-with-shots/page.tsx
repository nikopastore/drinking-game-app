...
export default function ShotGamesPage() {
  return (
    <GuideLayout title="Best Drinking Games with Shots" description="Ready to up the stakes? These games use shots instead of beer for faster, more intense gameplay. Handle with care!" breadcrumb="Shot Games" relatedGames={[{ name: "Quarters", slug: "quarters", description: "Make it = they shoot" }, { name: "Power Hour", slug: "power-hour", description: "Mini shots" }]}>
      ...
      <ul><li><strong>Shot Roulette</strong> - Spin the wheel, take what you get</li><li><Link href="/game/quarters" className="text-neon-pink">Quarters</Link> - Make it = opponent shots</li><li><strong>Battle Shots</strong> - Battleship with shot glasses</li><li><strong>Jenga Shots</strong> - Pull blocks, take shots</li></ul>
      <h2>Adapted Games</h2>
      <ul><li><Link href="/game/kings-cup" className="text-neon-pink">Kings Cup</Link> - Center cup = shot</li><li><Link href="/game/ride-the-bus" className="text-neon-pink">Ride the Bus</Link> - Miss = shot</li><li><strong>Shot Pong</strong> - Beer pong with shot glasses</li></ul>
      <h2>Safety Tips</h2>
