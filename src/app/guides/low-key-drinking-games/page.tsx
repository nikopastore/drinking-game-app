...
export default function LowKeyDrinkingGamesPage() {
  return (
    <GuideLayout title="Low Key Drinking Games" description="Not every night needs to be wild. These games are perfect for chill hangs, winding down, or when you want drinks without chaos." breadcrumb="Low Key Games" relatedGames={[{ name: "Truth or Drink", slug: "truth-or-drink", description: "Conversation focus" }, { name: "Ride the Bus", slug: "ride-the-bus", description: "Relaxed card game" }]}>
      <h2>Chill Games</h2>
      <ul><li><Link href="/games/truth-or-drink" className="text-neon-pink">Truth or Drink</Link> - Just conversation</li><li><Link href="/games/ride-the-bus" className="text-neon-pink">Ride the Bus</Link> - Quiet card game</li><li><Link href="/games/horse-race" className="text-neon-pink">Horse Race</Link> - Watch and sip</li><li><strong>Movie Drinking Games</strong> - Passive drinking</li></ul>
      <h2>Low Energy Vibes</h2>
      <ul><li><Link href="/games/never-have-i-ever" className="text-neon-pink">Never Have I Ever</Link> - Sitting game</li><li><Link href="/games/most-likely-to" className="text-neon-pink">Most Likely To</Link> - No movement needed</li><li><strong>Trivia</strong> - Thinking, not running</li></ul>
      <h2>Perfect For</h2>
