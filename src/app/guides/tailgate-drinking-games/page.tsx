...
export default function TailgateDrinkingGamesPage() {
  return (
    <GuideLayout title="Best Tailgate Drinking Games" description="The party before the party! Tailgating is an art form, and these games will make your setup the envy of the parking lot." breadcrumb="Tailgate Games" relatedGames={[{ name: "Flip Cup", slug: "flip-cup", description: "Team classic" }, { name: "Beer Pong", slug: "beer-pong", description: "The standard" }]}>
      ...
      <ul><li><strong>Cornhole</strong> - Add drinking rules for hits</li><li><Link href="/games/flip-cup" className="text-neon-pink">Flip Cup</Link> - Team rivalries</li><li><Link href="/games/beer-pong" className="text-neon-pink">Beer Pong</Link> - Bring a portable table</li><li><strong>Ladder Toss</strong></li><li><strong>KanJam</strong></li></ul>
      <h2>Quick Games Between Sets</h2>
      <ul><li><Link href="/games/most-likely-to" className="text-neon-pink">Most Likely To</Link></li><li><Link href="/games/quarters" className="text-neon-pink">Quarters</Link></li><li>Shotgun races</li></ul>
      <h2>Tailgate Tips</h2>
