...
export default function StPatricksDayPage() {
  return (
    <GuideLayout title="St. Patrick's Day Drinking Games" description="The one day a year everyone's Irish! These games celebrate with green beer, Irish pub traditions, and plenty of craic." breadcrumb="St. Patrick's Day Games" relatedGames={[{ name: "Irish Poker", slug: "irish-poker", description: "It's in the name!" }, { name: "Kings Cup", slug: "kings-cup", description: "Go green" }]}>
      ...
      <ul><li><Link href="/game/irish-poker" className="text-neon-pink">Irish Poker</Link> - Obviously essential</li><li><strong>Lucky Charms</strong> - Drink for each marshmallow type</li><li><strong>Pot of Gold</strong> - Hide gold coins, finder gives drinks</li></ul>
      <h2>Pub Games</h2>
      <ul><li><Link href="/game/quarters" className="text-neon-pink">Quarters</Link> - Bar classic</li><li><strong>Darts</strong> - Drink for low scores</li><li><Link href="/game/three-man" className="text-neon-pink">Three Man</Link></li></ul>
      <h2>Green Rules</h2>
