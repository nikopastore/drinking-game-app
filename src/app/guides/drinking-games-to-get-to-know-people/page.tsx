...
export default function DrinkingGamesToGetToKnowPeoplePage() {
  return (
    <GuideLayout title="Drinking Games to Get to Know People" description="Want to actually learn about the people you're drinking with? These games encourage sharing, questions, and real conversation." breadcrumb="Get to Know People" relatedGames={[{ name: "Never Have I Ever", slug: "never-have-i-ever", description: "Instant revelations" }, { name: "Truth or Drink", slug: "truth-or-drink", description: "Deep questions" }]}>
      ...
      <ul><li><Link href="/games/never-have-i-ever" className="text-neon-pink">Never Have I Ever</Link> - Life experiences revealed</li><li><Link href="/games/truth-or-drink" className="text-neon-pink">Truth or Drink</Link> - Real answers</li><li><strong>Two Truths One Lie</strong> - Learn facts</li><li><strong>21 Questions</strong> - Drinking edition</li></ul>
      <h2>Conversation Starters</h2>
      <ul><li><strong>Would You Rather</strong> - Preferences revealed</li><li><strong>This or That</strong> - Quick takes</li><li><Link href="/games/most-likely-to" className="text-neon-pink">Most Likely To</Link> - First impressions</li></ul>
