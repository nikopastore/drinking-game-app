...
export default function QuickGamesPage() {
  return (
    <GuideLayout title="Quick Drinking Games" description="No time for a full game of Kings Cup? These games are lightning fast - perfect for pregaming or quick rounds." breadcrumb="Quick Games" relatedGames={[{ name: "Medusa", slug: "medusa", description: "30-second rounds" }, { name: "Flip Cup", slug: "flip-cup", description: "2-minute games" }]}>
      ...
      <ul><li><Link href="/game/medusa" className="text-neon-pink">Medusa</Link> - Instant rounds</li><li><Link href="/game/flip-cup" className="text-neon-pink">Flip Cup</Link> - One race, done</li><li><strong>Shot Roulette</strong> - Spin and drink</li><li><strong>Thunderstruck</strong> - One song</li></ul>
      <h2>5-10 Minutes</h2>
      <ul><li><Link href="/game/rage-cage" className="text-neon-pink">Rage Cage</Link> - Quick elimination</li><li><Link href="/game/ride-the-bus" className="text-neon-pink">Ride the Bus</Link> (short version)</li><li><strong>Speed Quarters</strong></li></ul>
